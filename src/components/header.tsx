  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 select-none">
      ...
      <div className="relative bg-white/90 dark:bg-gray-950/90 backdrop-blur-xl backdrop-saturate-150 border-b border-gray-200/50 dark:border-white/10">
        ...
        <div
          className={`absolute inset-0 opacity-[0.03] bg-[url('data:image/svg+xml,%3Csvg viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"%3E%3Cfilter id="noiseFilter"%3E%3CfeTurbulence type="fractalNoise" baseFrequency="0.9" numOctaves="4" stitchTiles="stitch"/%3E%3C/filter%3E%3Crect width="100%25" height="100%25" filter="url(%23noiseFilter)"/%3E%3C/svg%3E')]`}
        />
                ...
                {navItems.map((item) => (
                  <NavigationMenuItem key={item.name}>
                    <NavigationMenuLink asChild>
                      <a
                        href={item.href}
                        className="group relative px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors duration-200"
                      >
