...
const Testimonials = () => {
  const testimonials = [
    {
      name: "أمين ب.",
      title: "مدير تنفيذي، حلول تقنية",
      quote:
        "حولت sys.capital سير عمل أعمالنا من خلال أنظمة CRM و ERP الخاصة بهم. برامج بديهية وقوية!",
    },
    {
      name: "صوفيا ك.",
      title: "صاحبة متجر تجزئة",
      quote:
        "نظام POS والمعدات الخاصة بهم عززت كفاءة مبيعاتنا بشكل كبير. أنصح بها بشدة.",
    },
    {
      name: "نجيب م.",
      title: "مدير الموارد البشرية، شركة صناعية",
      quote: "نظام إدارة الموارد البشرية بسّط عملياتنا وحسّن رضا الموظفين.",
    },
  ];
  ...
  return (
    <section className="relative py-24 px-6 sm:px-8 max-w-7xl mx-auto select-text overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div
          className={`absolute inset-0 opacity-[0.015] bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23000" fill-opacity="0.1"%3E%3Cpath d="m36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')]`}
        />
      </div>
        ...
        <div className="text-center space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto font-light leading-relaxed font-inter">
              استمع إلى الأعمال التي حوّلت عملياتها بفضل
            ...
            const colors = [
              {
                ...
                dark: "from-sky-900/20 to-blue-900/20",
              },
              {
                bg: "#22c55e",
              ...
              },
              {
                ...
                dark: "from-purple-900/20 to-violet-900/20",
              },
            ];
            ...
            return (
              <div key={i} className="group relative">
                <Card className="relative overflow-hidden border-0 shadow-xl hover:shadow-2xl transform transition-all duration-500 hover:scale-105 hover:-translate-y-2 bg-white/95 dark:bg-black/95 backdrop-blur-sm h-full">
                  ...
                  <div
                    className="absolute left-0 top-0 bottom-0 w-2 rounded-l-xl bg-gradient-to-b"
                    style={{
                      background: `linear-gradient(to bottom, ${colorScheme.bg}, ${colorScheme.bg}90)`,
                    }}
                  >
                    <div
                      className="absolute inset-0 blur-sm opacity-50 group-hover:opacity-100 transition-opacity duration-300"
                  ...
                  <CardContent className="relative p-8 sm:p-10 space-y-6 h-full flex flex-col">
                    ...
                    <div className="relative">
                      <div
                        className={`inline-flex items-center justify-center w-12 h-12 rounded-2xl shadow-lg bg-gradient-to-r ${colorScheme.gradient} group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 group-hover:-rotate-3`}
                      >
                        <Quote
                      ...
                      <div
                        className={`absolute inset-0 w-12 h-12 rounded-2xl blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-300 bg-gradient-to-r ${colorScheme.gradient}`}
                      />
                    </div>
                    ...
                    <div className="flex-1 space-y-4">
                      <blockquote className="text-xl sm:text-2xl font-light leading-relaxed text-slate-700 dark:text-slate-300 italic group-hover:text-slate-800 dark:group-hover:text-slate-200 transition-colors duration-300 font-inter">
                        <span className="text-3xl font-bold text-slate-400 dark:text-slate-600 mr-1">
                          &quot;
                        </span>
                        {quote}
                        <span className="text-3xl font-bold text-slate-400 dark:text-slate-600 ml-1">
                          &quot;
                        </span>
                      </blockquote>
                      ...
                      <div className="w-16 h-1 rounded-full bg-slate-200 dark:bg-slate-700 relative overflow-hidden">
                        <div
                          className={`absolute top-0 left-0 h-full w-0 rounded-full group-hover:w-full transition-all duration-700 bg-gradient-to-r ${colorScheme.gradient}`}
                        />
                      </div>
                    </div>
                    ...
                    <footer className="space-y-3 pt-4 border-t border-slate-100 dark:border-slate-800">
                      <div className="flex items-center space-x-3">
                        ...
                        <div
                          className={`w-10 h-10 rounded-full bg-gradient-to-r ${colorScheme.gradient} flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110`}
                        >
                        ...
                        <div className="flex-1">
                          <p
                            className="text-lg font-bold tracking-wide text-slate-900 dark:text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text transition-all duration-300"
                            style={{
                              backgroundImage:
                                i === 0
                      ...
                      {/* Client type badge */}
                      <div
                        className={`inline-flex items-center space-x-2 bg-gradient-to-r ${colorScheme.light} dark:${colorScheme.dark} px-3 py-1 rounded-full backdrop-blur-sm border border-opacity-50`}
                        style={{ borderColor: colorScheme.bg + "30" }}
                      >
                        <div
                  ...
                  {/* Card glow effect */}
                  <div
                    className={`absolute -inset-2 rounded-xl blur-xl opacity-0 group-hover:opacity-20 transition-opacity duration-500 -z-10 bg-gradient-to-r ${colorScheme.gradient}`}
                  />
                </Card>
              </div>
            );
        ...
        <div className="text-center space-y-6 pt-8">
          <div className="flex justify-center items-center space-x-8">
            ...
            <p className="text-lg font-inter text-slate-600 dark:text-slate-400 font-light">
              ...
              <span className="font-semibold">مجرّب</span> •{" "}
          ...
          <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 px-6 py-3 rounded-full backdrop-blur-sm border border-blue-200/50 dark:border-blue-700/50">
            <div className="flex space-x-1">
              {[...Array(5)].map((_, i) => (
                <div
                  key={i}
                  className="w-1.5 h-1.5 rounded-full bg-gradient-to-r from-yellow-400 to-orange-400 animate-pulse"
