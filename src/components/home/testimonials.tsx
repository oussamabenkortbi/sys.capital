const Testimonials = () => {
  ...
  return (
    <section className="bg-white dark:bg-black py-24 px-6 text-black dark:text-white max-w-6xl mx-auto select-text">
      ...
      <div className="grid md:grid-cols-3 gap-20 text-xl font-light tracking-wide">
        {testimonials.map(({ name, title, quote }, i) => (
          <article key={i} className="space-y-6 border-l-4 border-black dark:border-white pl-8">
            <blockquote className="italic leading-relaxed text-black dark:text-gray-200">&ldquo;{quote}&rdquo;</blockquote>
            <footer className="font-semibold uppercase tracking-widest">
