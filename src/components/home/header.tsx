...
const Header = () => {
  ...
  return (
    <header className="fixed h-16 top-0 left-0 right-0 bg-white/95 dark:bg-black/95 backdrop-blur-sm border-b border-gray-100 dark:border-black z-50 select-text">
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white dark:bg-black border-t border-gray-200 dark:border-black uppercase font-black tracking-widest text-center py-8 space-y-10 text-2xl select-text">
