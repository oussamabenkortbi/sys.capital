...
const Partners = () => {
  return (
    <section className="bg-white dark:bg-black py-20 px-6 sm:px-8 max-w-7xl mx-auto text-black dark:text-white select-text text-center tracking-widest uppercase font-black text-2xl sm:text-3xl">
