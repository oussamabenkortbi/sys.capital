...
const SoftwareSolutions = () => {
  const solutions = [
    {
      ...
      description: 'Streamline your customer interactions and boost sales with intelligent automation and insights.',
      url: 'crm.sys.capital',
      color: '#0ea5e9',
      icon: Users,
    ...
    },
    {
      ...
      description: 'Unify all business processes in one integrated system for maximum efficiency and control.',
      url: 'erp.sys.capital',
      color: '#22c55e',
      icon: Boxes,
    ...
    },
    {
      ...
      description: 'Modern retail solution with real-time inventory, payments, and customer analytics.',
      url: 'pos.sys.capital',
      color: '#f59e0b',
      icon: CreditCard,
    ...
    },
    {
      ...
      description: 'Complete HR suite for recruitment, payroll, performance tracking, and employee engagement.',
      url: 'hr.sys.capital',
      color: '#a855f7',
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50 px-6 py-24 overflow-hidden">
      ...
      <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-sky-200/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="flex justify-center items-center gap-3 mb-6">
            ...
            <div className="w-2 h-2 rounded-full bg-pink-500 animate-pulse" style={{ animationDelay: '0.6s' }} />
          ...
          <h2 className="text-5xl lg:text-6xl font-black text-slate-900 mb-3">
            Your Site Deserves Better Than
          </h2>
          ...
          <p className="text-xl text-slate-600 mt-6 max-w-3xl mx-auto">
            One-size-fits-all software kills your ROI—every feature feels like a miss.
          </p>
        </div>
                ...
                <div className="relative bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 h-full">
                  ...
                  >
                    ...
                    <div className="relative h-56 overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200">
                      <div className={`absolute inset-0 bg-gradient-to-br ${solution.bgGradient} opacity-90 transition-all duration-700 group-hover:scale-110 ${rotation} group-hover:rotate-0`}>
      ...
      <div className="absolute top-1/3 right-20 w-2 h-2 rounded-full bg-purple-400 animate-bounce opacity-40" style={{ animationDelay: '0.5s' }} />
      <div className="absolute bottom-40 right-24 w-4 h-4 rounded-full bg-pink-400 animate-bounce opacity-40" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-1/3 left-24 w-2 h-2 rounded-full bg-sky-400 animate-bounce opacity-40" style={{ animationDelay: '1.5s' }} />
    </section>
  );
};
