...
const Services = () => {
  ...
  return (
    <section id="services" className="relative py-24 sm:py-28 md:py-32 px-6 sm:px-8 overflow-hidden">
          ...
          <div className="space-y-6">
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              <p className="text-xl sm:text-2xl text-slate-600 dark:text-slate-400 font-light leading-relaxed font-inter">
                <span className="font-semibold bg-gradient-to-r from-sky-600 to-violet-600 bg-clip-text text-transparent">End-to-end delivery</span>
                {' '}across web, mobile, integration, and support.
              </p>
              ...
              <div className="flex flex-wrap justify-center items-center gap-6 mt-6 text-sm font-medium">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-slate-600 dark:text-slate-400 font-inter">Development</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 rounded-full bg-green-400"></div>
                  <span className="text-slate-600 dark:text-slate-400 font-inter">Mobile</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 rounded-full bg-amber-400"></div>
                  <span className="text-slate-600 dark:text-slate-400 font-inter">Integration</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-3 h-3 rounded-full bg-purple-400"></div>
                  <span className="text-slate-600 dark:text-slate-400 font-inter">Support</span>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div className="flex items-start gap-5 group-hover:gap-6 transition-all duration-300">
                    ...
                    <div className="relative flex-shrink-0">
                      <div
                        ...
                        style={{ backgroundColor: color }}
                      >
                        <Icon className="size-7 text-white transition-transform duration-300 group-hover:scale-110" aria-hidden="true" />
                      </div>
                      {/* Icon glow effect */}
                      <div 
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      {/* Enhanced subtitle */}
                      <h4 className="text-sm sm:text-base font-bold uppercase tracking-[0.2em] text-slate-500 dark:text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300 transition-colors duration-300 font-inter">
                        {sub}
                      </h4>
                    </div>
                  </div>
                    ...
                    <p className="text-lg sm:text-xl font-light leading-relaxed text-slate-600 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors duration-300 font-inter">
                      {description.split(', ').map((tech, index, array) => (
                        <span key={index}>
                          ...
                          {index < array.length - 1 && <span className="mx-2 text-slate-400">•</span>}
                        </span>
                      ))}
                    </p>
                  </div>
        ...
        <div className="text-center mt-16 sm:mt-20 space-y-6">
          <div className="flex justify-center items-center space-x-8">
            ...
            <p className="text-lg font-inter text-slate-600 dark:text-slate-400 font-light">
              <span className="font-semibold">Comprehensive</span> • <span className="font-semibold">Reliable</span> • <span className="font-semibold">Scalable</span>
            </p>
