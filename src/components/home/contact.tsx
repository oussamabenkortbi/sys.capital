...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className="relative py-24 sm:py-28 md:py-32 px-6 sm:px-8 max-w-7xl mx-auto select-text overflow-hidden"
    >
      ...
      <div className="absolute inset-0 rounded-3xl overflow-hidden border border-white/10 dark:border-black/10 shadow-2xl">
        ...
        <div
          className={`absolute inset-0 opacity-[0.015] bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23000" fill-opacity="0.05"%3E%3Cpath d="M54.627 0l.83.828-1.415 1.415L51.8 0h2.827zM5.373 0l-.83.828L5.96 2.243L8.2 0H5.373zM48.97 0l3.657 3.657-1.414 1.414L46.143 0h2.828zM11.03 0L7.372 3.657l1.415 1.414L13.857 0H11.03zm32.284 0L49.8 6.485 48.384 7.9l-7.9-7.9h2.83zM6.686 0L0 6.686 1.414 8.1 8.1 1.414 6.686 0z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')]`}
        />
      </div>
          ...
          <div className="space-y-8 sm:space-y-10">
            <div className="space-y-6">
              ...
              {[
                ...
                <div
                  key={index}
                  className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-white/50 dark:hover:bg-black/50 transition-all duration-300 hover:shadow-lg backdrop-blur-sm"
                >
                  {/* Enhanced icon */}
                  <div className="relative flex-shrink-0">
                    <div
                      className={`relative size-12 flex items-center justify-center rounded-2xl shadow-lg bg-gradient-to-r ${gradient} group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 group-hover:-rotate-3`}
                    >
                      <Icon
                    ...
                    {/* Icon glow effect */}
                    <div
                      className={`absolute inset-0 size-12 rounded-2xl blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-300 bg-gradient-to-r ${gradient}`}
                    />
                  </div>
                  ...
                  <div className="flex-1 space-y-1">
                    ...
                    <p
                      className="text-lg sm:text-xl font-semibold text-slate-900 dark:text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text transition-all duration-300"
                      style={{
                        backgroundImage: `linear-gradient(to right, var(--${color}-500), var(--${color}-600))`,
                      }}
                    >
                      {value}
                    </p>
            ...
            <div className="bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-teal-950/30 dark:to-cyan-950/30 p-6 rounded-2xl backdrop-blur-sm border border-teal-200/50 dark:border-teal-700/50">
              ...
              <div className="space-y-2">
                <span className="text-slate-700 dark:text-slate-300 font-medium font-inter">
                  عادةً خلال ساعتين في أيام العمل
                </span>
              </div>
            </div>
          </div>
              ...
              <div className="text-center space-y-8 p-8 rounded-2xl bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/30 dark:to-emerald-950/30 border border-green-200/50 dark:border-green-700/50">
                <div className="space-y-4">
                  ...
                  <p className="text-green-600 dark:text-green-400 font-inter">
                    شكراً لتواصلك معنا. سنرد عليك خلال ساعتين عمل.
                  </p>
                </div>
              </div>
            ) : (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <option value="">ما الذي يهمك؟</option>
                      <option value="crm">نظام CRM</option>
                      <option value="erp">منصة ERP</option>
                      <option value="pos">نظام POS</option>
                      <option value="hr">إدارة الموارد البشرية</option>
                      <option value="hardware">الأجهزة والمعدات</option>
                      <option value="custom">تطوير مخصص</option>
                    </select>
                  </div>
                  ...
                  <div className="text-center space-y-6 pt-8">
                    <div className="flex justify-center items-center space-x-8">
                      ...
                      <p className="text-lg font-inter text-slate-600 dark:text-slate-400 font-light">
                        ...
                        <span className="font-semibold">سريع الاستجابة</span> •{" "}
