...
export function generateMetadata({
  ...
  if (!post) return { title: "المقال غير موجود — Sys.Capital" };
  return {
    title: `${post.title} — مدونة Sys.Capital`,
    ...
    <main className="min-h-screen bg-white dark:bg-black text-black dark:text-white select-text">
      <article className="max-w-3xl mx-auto py-16 sm:py-20 px-6">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <p>{post.excerpt}</p>
          <p>
            محتوى المقال الكامل قريباً. يمكننا التبديل إلى MDX أو نظام إدارة
            محتوى وعرض محتوى طويل هنا، بما في ذلك العناوين والصور ومقتطفات
            الأكواد.
          </p>
        </div>
      </article>
